    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnCaptureImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                launchCamera(view);
                Toasty.success(getContext(), "Launching camera", Toasty.LENGTH_SHORT, true).show();
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (description.isEmpty()) {
                    Toasty.error(getContext(), "You need a description", Toasty.LENGTH_SHORT, true).show();
                    return;
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                Toasty.error(getContext(), "Picture wasn't taken!", Toasty.LENGTH_SHORT, true).show();
            }
        }
    }
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null){
                    ...
                    Toasty.error(getContext(), "Error while saving", Toasty.LENGTH_SHORT,true).show();
                }
